<script lang="ts">
	...
	export let contentClass =
		'select-none rounded-2xl p-1 z-50 bg-white/85 dark:bg-gray-850/85 backdrop-blur-xl dark:text-white shadow-lg border border-gray-100 dark:border-gray-800';
