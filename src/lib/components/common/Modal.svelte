<script lang="ts">
	...
	export let className = 'bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-4xl';
	...
	>
		<div
			class="m-auto max-w-full {sizeToWidth(size)} {size !== 'full'
				? 'mx-2'
				: ''} shadow-3xl min-h-fit scrollbar-hidden {className} border border-gray-200/60 dark:border-gray-800"
			in:flyAndScale
			on:mousedown={(e) => {
				e.stopPropagation();
			}}
