			...
			<div>
						...
						<div class="flex items-center justify-between mb-2">
							...
							<label class="relative inline-flex items-center cursor-pointer">
								...
								<div
									...
									style={STT_MISTRAL_USE_CHAT_COMPLETIONS
										? 'background-color: hsl(var(--gpthub-accent-hue, 18) 65% 55%)'
										: ''}
								></div>
							</label>
						</div>
				...
				{:else if STT_ENGINE === ''}
					<div>
						...
						<div class="mt-2 mb-1 text-xs text-gray-400 dark:text-gray-500">
							{$i18n.t(`GPThub uses faster-whisper internally.`)}
				...
				<div class="mb-2">
					...
					{:else if TTS_ENGINE === 'transformers'}
						<div>
							...
							<div class="mt-2 mb-1 text-xs text-gray-400 dark:text-gray-500">
								{$i18n.t(`GPThub uses SpeechT5 and CMU Arctic speaker embeddings.`)}
