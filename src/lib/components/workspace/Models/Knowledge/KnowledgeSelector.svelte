...
>
	...
	<div slot="content">
		<div
			class="z-[10000] text-black dark:text-white rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 flex flex-col bg-white/85 dark:bg-gray-850/85 backdrop-blur-xl w-70 p-1.5"
		>
