		...
		<div class=" flex flex-col h-full px-3.5">
			<div class="flex w-full items-center gap-1.5">
				...
				<Dropdown>
					...
					<div slot="content">
						<div
							class="min-w-[200px] rounded-2xl px-1 py-1 border border-gray-100 dark:border-gray-800 z-50 bg-white/85 dark:bg-gray-850/85 backdrop-blur-xl dark:text-white shadow-lg"
						>
							<DropdownSub>
								<button
									slot="trigger"
