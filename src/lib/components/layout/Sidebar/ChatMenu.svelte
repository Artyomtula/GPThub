...
>
	...
	<div slot="content">
		<div
			class="select-none min-w-[200px] rounded-2xl px-1 py-1 border border-gray-100 dark:border-gray-800 z-50 bg-white/85 dark:bg-gray-850/85 backdrop-blur-xl dark:text-white shadow-lg transition"
		>
			...
			<DropdownSub
				contentClass="select-none rounded-2xl p-1 z-50 bg-white/85 dark:bg-gray-850/85 backdrop-blur-xl dark:text-white shadow-lg border border-gray-100 dark:border-gray-800"
			>
				<button
					slot="trigger"
					draggable="false"
			...
			{#if chatId && $folders.length > 0}
				<DropdownSub
					contentClass="select-none rounded-2xl p-1 z-50 bg-white/85 dark:bg-gray-850/85 backdrop-blur-xl dark:text-white border border-gray-100 dark:border-gray-800 shadow-lg max-h-52 overflow-y-auto scrollbar-hidden"
				>
					<button
						slot="trigger"
						draggable="false"
