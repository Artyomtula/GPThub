...
VIRTUAL_MODEL_SPECS: tuple[VirtualModelSpec, ...] = (
    VirtualModelSpec(
        ...
        name='Auto Router',
        capability='auto',
        description='Automatically chooses the best model for each request.',
    ...
    VirtualModelSpec(
        ...
        capability='text',
        description='General-purpose assistant for text and analysis tasks.',
        tags=('GPTHub', 'Virtual', 'Text'),
    ),
    VirtualModelSpec(
        id='gpthub:code',
        name='Code Assistant',
        capability='code',
        description='Optimized for coding, debugging, and technical explanations.',
    ...
    VirtualModelSpec(
        ...
        name='Vision Analyst',
        capability='vision',
        description='Best suited for image understanding and visual analysis.',
    ...
    VirtualModelSpec(
        ...
        description='Routes requests to text-to-image generation models.',
