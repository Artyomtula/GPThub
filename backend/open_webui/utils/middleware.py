...
# ---------------------------------------------------------------------------
# Presentation generation – extracted to gpthub_presentation.py
# ---------------------------------------------------------------------------
from open_webui.utils.gpthub_presentation import (
    chat_presentation_handler as _gpthub_chat_presentation_handler,
)


async def chat_presentation_handler(request: Request, form_data: dict, extra_params: dict, user):
    return await _gpthub_chat_presentation_handler(
        request,
        form_data,
        extra_params,
        user,
        generate_chat_completion_fn=generate_chat_completion,
        image_generations_fn=image_generations,
        create_image_form_cls=CreateImageForm,
        get_last_user_message_fn=get_last_user_message,
        get_task_model_id_fn=get_task_model_id,
        add_or_update_system_message_fn=add_or_update_system_message,
    )
